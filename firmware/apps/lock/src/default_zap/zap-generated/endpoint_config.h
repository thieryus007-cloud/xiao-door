  ...
  {                                                                            \
    ...
    {ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),                      \
     ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                    \
        ...
        {ZAP_SIMPLE_DEFAULT(8), 0x00000017, 1, ZAP_TYPE(INT8U),                \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* MaxPINCodeLength */                 \
        {ZAP_SIMPLE_DEFAULT(6), 0x00000018, 1, ZAP_TYPE(INT8U),                \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* MinPINCodeLength */                 \
...
#define GENERATED_ENDPOINT_TYPES                                               \
  { {ZAP_CLUSTER_INDEX(0), 16, 25}, {ZAP_CLUSTER_INDEX(16), 4, 34}, }
